...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        if learning_state == 0: # reset
            ...
            sim_utils.schemas.modify_mass_properties(prim_path="/World/envs/env_0/Robot/weight_link",cfg=sim_utils.schemas.MassPropertiesCfg(mass=args_cli.mass))
...
def main():
    ...
    sim.set_camera_view([0.0, 2.0, 1.2], [0.0, 0.0, 0.5])
    # Design scene
